<nav class="bg-emerald-900 shadow-md">
    <div class="w-8/10 mx-auto flex flex-row justify-between items-center py-4 text-white">
        ...
        <ul class="flex flex-row gap-8 items-center text-lg font-medium">
            ...
            <li><a href="/menu" class="hover:text-amber-400 transition-colors duration-300">Menú</a></li>
            <li><a href="/nosotros" class="hover:text-amber-400 transition-colors duration-300">Nosotros</a></li>
            <li>
                <div class="w-10 h-10 bg-emerald-800 rounded-full flex items-center justify-center hover:bg-emerald-700 transition-colors cursor-pointer">
